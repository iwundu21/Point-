                ...
                <Separator />
                    ...
                    <div>
                        <Alert className="border-blue-500/20 bg-blue-500/10 text-center mb-4">
                            ...
                            <AlertBoxDescription className="text-blue-400/80">
                                All users with earned Points and a submitted wallet are eligible for the airdrop.
                            </AlertBoxDescription>
                        </Alert>
                        {renderWalletUI()}
                    </div>
                 ...
                 <Card className="bg-primary/5 border-primary/10">
                    <CardHeader>
                        ...
                        <CardDescription className="text-xs">Your airdrop status summary.</CardDescription>
                    </CardHeader>
                    <CardContent>
                       ...
                       <p className="text-xs text-muted-foreground mt-3 text-center">
                         A submitted wallet address is required to check your eligibility.
                       </p>
                    </CardContent>
                </Card>
